...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_metal-toolbox_conditionorc_pkg_api_v1_orchestrator_types.ServerResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_metal-toolbox_conditionorc_pkg_api_v1_orchestrator_types.ServerResponse": {
            "type": "object",
            "properties": {
                "condition": {
